...
const renderComponent = (weatherData = mockWeatherData, tempUnit = 'metric', theme = 'light') => {
  ...
  useWeather.mockReturnValue({ weatherData, tempUnit });
...
describe('WeatherDetails', () => {
  ...
  it('should display correct temperature and feels like', () => {
    renderComponent();
  ...
  it('should display correct weather conditions', () => {
    renderComponent();
  ...
  it('should display correct humidity, wind speed, pressure, and visibility', () => {
    renderComponent();
